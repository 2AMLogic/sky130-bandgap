# Bandgap-core routed layout record: 20260806-094830-90ef982
...
| 2 | Resistor ladder at real unit count | MET | `res_r2` num=96 (= 2 legs x 48 coarse 5um units) + `res_trim` num=40 (= 2 legs x 20 fine 0.5um units) = 250 um/leg at DR-002 code 0, against design/bandgap_core.sch's `r_lseg*n_r2` = 250 um (delta +0 um); composed bbox 45,968 um^2 vs 50,000 um^2 budget |
...
- [x] Composed bbox area (45,968 um^2) is within the < 0.05 mm^2 (50,000 um^2) budget, **at the real full-length ladder count** (96 coarse + 40 fine units)
...
| `VSS` | `pnp_ctat:VSS trunk` -> `amp_nmirr:VSS:far0` | (27.66, 0.31) -> (203.53, 103.233) | 3-point |
...
- Record ID: `20260806-094830-90ef982`
- `klt` version: `klt 0.2.0` (pinned, see `layout/requirements.txt`)
- KLayout engine version: `0.30.10`
- Repo state: `90ef982f3c2659c45e3c388227d2d483c7dbef73` on `feature/issue-112` (dirty)
