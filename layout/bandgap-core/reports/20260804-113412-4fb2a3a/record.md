# Bandgap-core routed layout record: 20260804-113412-4fb2a3a
...
- Record ID: `20260804-113412-4fb2a3a`
- `klt` version: `klt 0.1.0` (pinned, see `layout/requirements.txt`)
- KLayout engine version: `0.30.10`
- Repo state: `4fb2a3abcc878dc846a5cf52fbe50c98fa7a3bd9` on `feature/issue-62` (dirty)
