# Layout DRC/LVS record: 20260803-133256-69a6ac2
...
- bbox (um): {'x0': -1.52, 'y0': 0.0, 'x1': 4.16, 'y1': 1.24}
...
| LVS negative control: device parameter | mismatch | mismatch_count=62 |
| LVS negative control: topology (shorted net) | mismatch | mismatch_count=60 |

The good-reference LVS run's `mismatch_count` (12) is nonzero but `status` is `"match"` -- all 12 entries are `severity: "warning"` (0 at `severity: "error"`; see `lvs.json`), documented, expected quirks for this minimal, highly symmetric cell:
...
- Record ID: `20260803-133256-69a6ac2`
...
- Repo state: `69a6ac252e222184eff942886e1a46e2073f7082` on `feature/issue-14` (dirty)
