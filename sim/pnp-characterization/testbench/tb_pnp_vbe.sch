...
* model card), the EMITTER biased by independent ideal DC current sources
* spanning 100 nA .. 100 uA (log half-decade steps) so one .op analysis
* captures the full VBE-vs-Ic sweep at a single PVT point -- the corner
* runner sweeps PVT around this fixed bias ladder.
*
...
*
* PIN-ORDER TRAP (issue #35) -- read before touching the current-source
* connections. The pnp_05v5 symbol draws the emitter at the TOP of the
* device body and the collector at the BOTTOM, and xschem emits @pinlist in
* the symbol file's B-line order (collector, base, emitter), which is the
* order .subckt sky130_fd_pr__pnp_05v5_* c b e expects. The symbol's
* `pinnumber` attributes (base=1, emitter=2, collector=3) do NOT match that
* order and are a red herring for netlisting. Between #4 and #35 the
* lab_pin labels on each device were swapped -- the current source landed on
* the bottom (collector) pin -- so the ladder measured the base-collector
* junction rather than VEB: 0.545 V instead of 0.743 V at tt/27 C/1 uA.
* ALWAYS verify against the emitted netlist, not the drawing: every XQ*
* line must read `XQ<n> 0 0 <driven-node> ...`, i.e. the driven node third.
*
...
C {devices/lab_pin.sym} 220 -130 0 0 {name=qeS0 lab=E_small_100n}
C {devices/lab_pin.sym} 220 -70 0 0 {name=qcS0 lab=0}
...
C {devices/lab_pin.sym} 220 -530 0 0 {name=qeL0 lab=E_large_100n}
C {devices/lab_pin.sym} 220 -470 0 0 {name=qcL0 lab=0}
...
C {devices/lab_pin.sym} 470 -130 0 0 {name=qeS1 lab=E_small_316n}
C {devices/lab_pin.sym} 470 -70 0 0 {name=qcS1 lab=0}
...
C {devices/lab_pin.sym} 470 -530 0 0 {name=qeL1 lab=E_large_316n}
C {devices/lab_pin.sym} 470 -470 0 0 {name=qcL1 lab=0}
...
C {devices/lab_pin.sym} 720 -130 0 0 {name=qeS2 lab=E_small_1u}
C {devices/lab_pin.sym} 720 -70 0 0 {name=qcS2 lab=0}
...
C {devices/lab_pin.sym} 720 -530 0 0 {name=qeL2 lab=E_large_1u}
C {devices/lab_pin.sym} 720 -470 0 0 {name=qcL2 lab=0}
...
C {devices/lab_pin.sym} 970 -130 0 0 {name=qeS3 lab=E_small_3p16u}
C {devices/lab_pin.sym} 970 -70 0 0 {name=qcS3 lab=0}
...
C {devices/lab_pin.sym} 970 -530 0 0 {name=qeL3 lab=E_large_3p16u}
C {devices/lab_pin.sym} 970 -470 0 0 {name=qcL3 lab=0}
...
C {devices/lab_pin.sym} 1220 -130 0 0 {name=qeS4 lab=E_small_10u}
C {devices/lab_pin.sym} 1220 -70 0 0 {name=qcS4 lab=0}
...
C {devices/lab_pin.sym} 1220 -530 0 0 {name=qeL4 lab=E_large_10u}
C {devices/lab_pin.sym} 1220 -470 0 0 {name=qcL4 lab=0}
...
C {devices/lab_pin.sym} 1470 -130 0 0 {name=qeS5 lab=E_small_31p6u}
C {devices/lab_pin.sym} 1470 -70 0 0 {name=qcS5 lab=0}
...
C {devices/lab_pin.sym} 1470 -530 0 0 {name=qeL5 lab=E_large_31p6u}
C {devices/lab_pin.sym} 1470 -470 0 0 {name=qcL5 lab=0}
...
C {devices/lab_pin.sym} 1720 -130 0 0 {name=qeS6 lab=E_small_100u}
C {devices/lab_pin.sym} 1720 -70 0 0 {name=qcS6 lab=0}
...
C {devices/lab_pin.sym} 1720 -530 0 0 {name=qeL6 lab=E_large_100u}
C {devices/lab_pin.sym} 1720 -470 0 0 {name=qcL6 lab=0}
